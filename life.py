    ...
    for fila in range(len(mapa)):
        ...
        for columna in range(len(mapa[0])):
            if mapa[fila][columna] == '#':
                estado_juego[fila].append(True)
            else:
                estado_juego[fila].append(False)
...
def life_mostrar(life):
    ...
    for fila in range(len(life)):
        lista_cadenas.append('')
        for columna in range(len(life[0])):
            if life[fila][columna] == True:
                lista_cadenas[fila] += '#'
            else:
                lista_cadenas[fila] += '.'
